...
const ProductDetails = ({ data, setOpen }) => {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 bottom-0 z-50 bg-[#0000006b] flex justify-center items-center">
      <div
        onClick={() => setOpen(false)}
        className="absolute top-0 bottom-0 right-0 left-0"
      ></div>
      <div className="bg-white w-[80%] h-[90%] overflow-y-auto rounded-2xl relative z-10">
        {data ? (
